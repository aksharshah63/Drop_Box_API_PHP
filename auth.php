    ...
    if(isset($_REQUEST['submit']))
    {
      ...
      if($_POST['client_id']!="" && $_POST['redUri']!="" && $_POST['client_secret']!="" && $_POST['code']!="")
      {
        ...
        curl_setopt_array($curl, array(
          ...
          CURLOPT_POSTFIELDS => 'code='.$code.'&grant_type=authorization_code&redirect_uri='.$redUri.'&client_id='.$client_id.'&client_secret='.$client_secret,
            ...
            <div class="panel-body" >
                ...
                <div id="user_id" class="form-group required">
                  ...
                  <div class="controls col-md-8 ">
                      <input class="input-md  textinput textInput form-control" id="user_id"  name="client_id" style="margin-bottom: 10px" type="text" value="lu907ciokibdszj"/>
                ...
                <div id="user_id" class="form-group required">
                  ...
                  <div class="controls col-md-8 ">
                      <input class="input-md  textinput textInput form-control" id="user_id"  name="client_secret" style="margin-bottom: 10px" type="text" value="qzyevlpd4kmfq3z" placeholder="1" />
